...
public class Reader  implements Callable<ConcurrentLinkedQueue<String>> {
    ...
    public ConcurrentLinkedQueue<String> reade(String[] array, String fileName) {
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            while ((paragraph = br.readLine())!=null) {
                makeSentence(array, paragraph, stringConcurrentLinkedQueue);
            }
        } catch (IOException e) {
     ...
     */
    private void makeSentence(String[] array, String paragraph, ConcurrentLinkedQueue<String> strings) {
        String sentence;
     ...
     */
    private void searchSentences(String[] array, String sentence, ConcurrentLinkedQueue<String> strings) {
